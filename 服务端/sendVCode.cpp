...
#define SENDER_EMAIL "1827369463@qq.com"//发件人的邮箱地址
#define SENDER_MAIL_AUTHORIZATION_CODE "wsektjwtrzqtbcgd"//发件人邮箱的授权码
...
int main(int argc,char**argv) {
    ...
    std::string from = SENDER_EMAIL; // 发件人QQ邮箱
    std::string password = SENDER_MAIL_AUTHORIZATION_CODE; // 发件人授权码
    std::string to_qq_number = argv[1]; // 收件人QQ邮箱
    std::string subject = "verificaton code"; // 邮件主题
    ...
    server_addr.sin_port = htons(587); // 使用SSL端口587
	//120.232.69.34是qq邮箱服务器地址
